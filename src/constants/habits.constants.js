...
export const WAKE_TARGET = '08:30';
...
export const MOVEMENT_SITTING_BREAK_POINTS = 1;
export const MOVEMENT_FOCUS_MINUTES = 60;
export const MOVEMENT_ACTIVE_BREAK_MINUTES = 15;
